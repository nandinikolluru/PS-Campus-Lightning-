...
void AWebSocketTestCharacter::NotifyServer()
{
	...
	if (GameInstance)
	{
		...
		{
			GameInstance->Socket->Send("{\"action\":\"sendmessage\",\"message\":\"on\"}");
		}
	}
}

void AWebSocketTestCharacter::NotifyServerOff()
{
	UWebSocketTestGameInstance* GameInstance = Cast<UWebSocketTestGameInstance>(GetGameInstance());
	...
	if (GameInstance)
	{
		if (GameInstance->Socket->IsConnected())
		{
			GameInstance->Socket->Send("{\"action\":\"sendmessage\",\"message\":\"off\"}");
		}
	}
}
...
void AWebSocketTestCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("NotifyServerOff", IE_Pressed, this, &AWebSocketTestCharacter::NotifyServerOff);
}
